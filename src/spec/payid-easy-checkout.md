...
initiate a payment from a customer using only the customer's PayID. 
...
representing a resource that the customer's digital wallet can use to initiate a payment to the merchant. 
